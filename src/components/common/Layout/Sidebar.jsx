            ...
            icon: (
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581a1.125 1.125 0 0 0 1.591 0l4.318-4.318a1.125 1.125 0 0 0 0-1.591l-9.581-9.581c-.422-.422-.994-.659-1.59-.659Z"
                />
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            icon: (
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M21 7.5V18a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18V7.5m18 0V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v1.5m18 0h-18M5.25 9h.007v.008H5.25V9Zm.007 3h.008v.008H5.25V12Zm0 3h.008v.008H5.25V15Z"
                />
              </svg>
            ),
          },
            ...
            icon: (
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 0 0 6.16-12.12A14.98 14.98 0 0 0 9.64 8.38a14.98 14.98 0 0 0-6.16 12.12A14.98 14.98 0 0 0 15.59 14.37Z"
                />
              </svg>
            ),
          },
            ...
            icon: (
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M21 7.5V18a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18V7.5m18 0V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v1.5m18 0h-18"
                />
              </svg>
            ),
          },
            ...
            icon: (
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M9.53 16.122a3 3 0 0 0-3.078 0L3.75 17.5a.75.75 0 0 0-.375.65v3a.75.75 0 0 0 .75.75h15.75a.75.75 0 0 0 .75-.75v-3a.75.75 0 0 0-.375-.65l-2.702-1.378a3 3 0 0 0-3.078 0l-.775.395a1.5 1.5 0 0 1-1.5 0l-.775-.395Z"
                />
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
