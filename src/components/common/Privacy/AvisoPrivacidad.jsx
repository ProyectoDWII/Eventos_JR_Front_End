      ...
      <div className="flex items-start gap-3">
        ...
        <div className="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
          <label
            ...
            className="cursor-pointer select-none font-medium text-zinc-700 dark:text-zinc-300"
          >
            Doy mi consentimiento para el tratamiento de mis datos personales.
          </label>
          <p className="mt-1.5 text-zinc-500 dark:text-zinc-500 text-[11px] sm:text-xs">
            <strong>Aviso Simplificado:</strong> Eventos JR utilizará los datos
            aquí recabados únicamente para la finalidad del servicio solicitado
            (gestión de cuentas, cotizaciones de eventos o atención a sus
            mensajes). Para mayor detalle acerca del tratamiento, las
            transferencias y el ejercicio de sus <strong>derechos ARCO</strong>,
            consulte nuestro{' '}
            <Link
              to="/aviso-privacidad"
