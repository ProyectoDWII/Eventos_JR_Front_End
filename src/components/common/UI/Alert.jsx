...
export default function Alert({
  ...
  const typeStyles = {
    success: {
      container: 'bg-emerald-500/10 border-emerald-500/20 text-emerald-800 dark:text-emerald-400',
      icon: (
    ...
    error: {
      container: 'bg-red-500/10 border-red-500/20 text-red-800 dark:text-red-400',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 flex-shrink-0">
    ...
    warning: {
      container: 'bg-amber-500/10 border-amber-500/20 text-amber-800 dark:text-amber-400',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 flex-shrink-0">
    ...
    info: {
      container: 'bg-sky-500/10 border-sky-500/20 text-sky-800 dark:text-sky-400',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 flex-shrink-0">
          <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 111.063.852l-.708 2.836a.75.75 0 001.063.852l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
        </svg>
      )
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 pr-4">
        {title && <h4 className="font-bold tracking-tight mb-1 text-sm">{title}</h4>}
