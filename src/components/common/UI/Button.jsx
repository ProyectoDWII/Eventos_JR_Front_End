...
export default function Button({
  ...
  const variantStyles = {
    primary:
      'bg-primary hover:opacity-95 active:scale-[0.98] text-white shadow-md shadow-primary/10',
    secondary:
      'bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700/80 active:scale-[0.98] text-zinc-800 dark:text-zinc-200',
    danger:
      'bg-red-600 hover:bg-red-750 active:scale-[0.98] text-white shadow-md shadow-red-500/10',
    outline:
      'border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/80 active:scale-[0.98] text-zinc-700 dark:text-zinc-300',
