      ...
      <div className="bg-gradient-to-r from-indigo-600 via-indigo-750 to-indigo-850 rounded-3xl p-6 md:p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4 max-w-2xl">
          ...
          <p className="text-sm text-indigo-100 font-medium leading-relaxed">
            Te damos la bienvenida a tu centro de control en Eventos JR. Aquí
            podrás cotizar coberturas, personalizar paquetes fotográficos y
            llevar el control total de los contratos de tus eventos especiales.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200/50 dark:border-zinc-800/50 rounded-3xl p-6 hover:shadow-xl transition duration-300 flex flex-col justify-between group">
          <div className="space-y-3">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Explora las especialidades de cobertura, fotografía digital,
              catering e iluminación para tu fiesta.
            </p>
          </div>
          <Link
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200/50 dark:border-zinc-800/50 rounded-3xl p-6 hover:shadow-xl transition duration-300 flex flex-col justify-between group">
          <div className="space-y-3">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Personaliza las horas de cobertura fotográfica, número de copias
              impresas y extras del contrato.
            </p>
          </div>
          <Link
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200/50 dark:border-zinc-800/50 rounded-3xl p-6 hover:shadow-xl transition duration-300 flex flex-col justify-between group">
          <div className="space-y-3">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Consulta el estado de aprobación de tu evento o ve tus contratos
