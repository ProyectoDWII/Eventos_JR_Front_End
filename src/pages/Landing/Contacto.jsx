...
export default function Contacto() {
  ...
  const handleSubmit = (e) => {
    ...
    // Sanitización preventiva contra ataques XSS
    const sanitizedNombre = DOMPurify.sanitize(nombre);
    const sanitizedEmail = DOMPurify.sanitize(email);
    const sanitizedTelefono = DOMPurify.sanitize(telefono);
    ...
    if (!acceptedPrivacy) {
      newErrors.privacy =
        'Debe aceptar el Aviso de Privacidad y consentir el tratamiento de sus datos para enviar el mensaje.';
    }
    ...
    setErrors({});
    setLoading(true);
    // Simulate API call with 1.5 seconds latency
    setTimeout(() => {
      setLoading(false);
      setSubmitted(true);
      console.log('Mensaje enviado (Sanitizado XSS):', { 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 mt-3 text-sm sm:text-base leading-relaxed">
            ¿Tienes dudas, deseas cotizar un evento especial o necesitas
            soporte? Escríbenos y nuestro equipo te atenderá a la brevedad.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-6">
                ...
                <span className="flex items-center justify-center w-10 h-10 rounded-xl bg-indigo-50 dark:bg-indigo-950 text-indigo-655 dark:text-indigo-400 shrink-0">
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-1.514 2.018a14.979 14.979 0 01-8.623-8.623l2.017-1.514c.362-.272.53-.733.418-1.173L11.563 3.97a1.09 1.09 0 00-1.091-.852H8.25A2.25 2.25 0 006 5.25v2.25z"
                    />
                  </svg>
                </span>
                <div>
            ...
            <div className="bg-gradient-to-tr from-indigo-600 to-cyan-500 p-6 rounded-2xl text-white shadow-md">
              ...
              <p className="text-xs text-indigo-50 leading-relaxed">
                De conformidad con la Ley General de Protección de Datos
                Personales en Posesión de Sujetos Obligados/Particulares
                (LGPDPPSO), garantizamos que la información ingresada en este
                formulario de contacto está estrictamente resguardada y solo se
                utilizará para atender sus mensajes y cotizaciones.
              </p>
            </div>
          </div>
            ...
            <div className="mb-6 bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-100 dark:border-indigo-900/50 rounded-xl p-4 text-xs text-indigo-800 dark:text-indigo-300 flex items-start gap-2.5">
              ...
              <div>
                ...
                <p className="mt-0.5 leading-relaxed text-zinc-650 dark:text-zinc-400">
                  Eventos JR protege su información. Por favor, lea nuestro
                  aviso simplificado al final de la página y marque la casilla
                  para habilitar el envío del mensaje.
                </p>
              </div>
            </div>
            ...
            {submitted ? (
              <div className="bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-250 dark:border-emerald-900/50 rounded-2xl p-8 text-center shadow-sm">
                ...
                <p className="text-sm text-emerald-755 dark:text-emerald-450 mt-2 leading-relaxed">
                  Gracias por escribirnos. Hemos registrado tu consentimiento
                  conforme a la LGPDPPSO y nos comunicaremos contigo lo antes
                  posible.
                </p>
                <button
                  onClick={() => {
