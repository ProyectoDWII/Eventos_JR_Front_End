...
export default function ServiciosDestacados() {
  const servicios = [
    {
      ...
      descripcion:
        'Sesiones artísticas, cobertura completa durante el evento, edición digital y entrega en alta definición.',
      detalles: [
    ...
    },
    {
      ...
      descripcion:
        'Planeación de principio a fin, coordinación de proveedores, logística, decoración y dirección el día del evento.',
      detalles: [
        'Asesoría de diseño',
        'Gestión de locación',
    ...
    },
    {
      ...
      descripcion:
        'Menús personalizados, postres de alta repostería y servicios de coctelería adaptados a tu presupuesto.',
      detalles: [
        'Degustación previa',
        'Opciones vegetarianas/veganas',
        'Servicio de meseros calificados',
      ],
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 8.25v-1.5m0 1.5c-1.355 0-2.697-.056-4.024-.166C6.845 7.96 6 7.005 6 5.912V4.5h12v1.413c0 1.092-.845 2.048-1.977 2.172A38.62 38.62 0 0112 8.25zM12 15.75V21m-3.75-3.75h7.5"
          />
        </svg>
      ),
    },
  ...
  return (
    <section
      id="servicios"
      className="py-16 md:py-24 bg-white dark:bg-zinc-900 border-y border-zinc-200 dark:border-zinc-800 transition duration-300"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-zinc-500 dark:text-zinc-400 mt-3 text-sm sm:text-base leading-relaxed">
            Te ofrecemos soluciones a la medida para que disfrutes de tu gran
            día sin preocupaciones.
          </p>
        </div>
            ...
            >
              ...
              <ul className="space-y-2">
                {servicio.detalles.map((detalle, idx) => (
                  <li
                    key={idx}
                    className="flex items-center gap-2 text-xs text-zinc-650 dark:text-zinc-400"
                  >
                    <svg
